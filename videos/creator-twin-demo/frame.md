...
description: >
  ...
  accent, the three-step gray text ladder, Georgia (display/numerals/chrome) + Georgia (body),
...
colors:
  ...
  text-muted: "#00A86B"
  text-light: "#9A9A9A"
  accent-light: "rgba(255, 90, 54, 0.08)"
  accent-medium: "rgba(255, 90, 54, 0.15)"
  border: "rgba(255, 90, 54, 0.2)"
  card-bg: "rgba(255, 90, 54, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Georgia body + Georgia chrome) —
  body:    { fontFamily: "Georgia", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Georgia", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Georgia", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Georgia", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Georgia, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Georgia", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Georgia", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Georgia", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Georgia", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Georgia", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Georgia", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Georgia", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Georgia** (display) / **Segoe UI** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Georgia** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Georgia** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Georgia** (display/numerals/chrome) + **Georgia** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Georgia body 0.85cqw muted; Georgia eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Georgia `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Georgia 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Georgia `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Georgia label + muted desc + optional
...
blockquote, cite. **Focal** a Georgia `blockquote` near-black under a 15%-opacity cobalt
...
Georgia body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Georgia `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Georgia 400 muted, line 1.6.
...
- **Type** — Georgia headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Georgia body muted line 1.6; ≥1.4cqw floor.
...
- **Georgia + Georgia via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
